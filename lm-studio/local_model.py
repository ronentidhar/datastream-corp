...
Prereqs:
  lms server start
  lms load google/gemma-4-26b-a4b   # stronger tool-caller; Llama 3.1 8B loops here

Override the model/endpoint with env vars if needed:
  LOCAL_MODEL_ID   (default: google/gemma-4-26b-a4b)
...
def get_model() -> OpenAIModel:
    ...
    return OpenAIModel(
        ...
        model_id=os.environ.get("LOCAL_MODEL_ID", "google/gemma-4-26b-a4b"),
